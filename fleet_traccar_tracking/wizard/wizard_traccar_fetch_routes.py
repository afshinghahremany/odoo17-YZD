...
class WizardTraccarFetchRoutes(models.TransientModel):
    _name = "wizard.traccar.fetch.routes"
    _description = "Traccar Fetch Routes Wizard"
    ...
    def action_fetch_routes(self):
        ...
        self.env['traccar.route.details'].sudo().cron_update_route_details(to_date, from_date)
        title = 'Message'
